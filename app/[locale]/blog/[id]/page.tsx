    ...
    <div className="pt-24">
      ...
      <div className="container-custom mb-10">
        <Link href={`/${locale}/blog`} className="inline-flex items-center text-charcoal-600 hover:text-charcoal transition-all">
          <ArrowLeft size={18} className="mr-2" /> {t('article.backToBlog')}
        </Link>
      </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex items-center justify-center gap-6 text-sm text-charcoal-600 mb-10">
            <span className="flex items-center gap-2">
              <User size={16} /> {translatedArticle.author}
            </span>
            <span className="flex items-center gap-2">
              <Clock size={16} /> {translatedArticle.readTime} {t('article.readTime')}
            </span>
            <span className="opacity-70">{translatedArticle.date}</span>
          </div>
        </div>
      ...
      <section className="container-custom grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-16 mb-32">
        ...
        <aside className="space-y-10">
          <div>
            ...
            <p className="font-semibold text-charcoal mb-1">{translatedArticle.author}</p>
          ...
          <div>
            ...
            <span className="text-olive font-medium capitalize">{translatedArticle.category.replace('-', ' ')}</span>
          </div>
        </aside>
      </section>
      ...
      <section className="container-custom mb-32">
        <h2 className="text-3xl font-serif font-bold text-charcoal mb-10">{t('article.relatedArticles')}</h2>
